...
class _RidePrefFormState extends State<RidePrefForm> {
  ...
  void initState() {
    super.initState();
    _initializeFormFields(widget.initialPreference);
  }

  // New method to initialize or reset form fields
  void _initializeFormFields(RidePreference? preference) {
    if (preference != null) {
  ...
  void didUpdateWidget(RidePrefForm oldWidget) {
    ...
    // Reinitialize form fields if the initial preference has changed
  ...
  // Getter methods for labels and visibility
  String get departureLabel =>
      departure != null ? departure!.name : "Leaving from";
  String get arrivalLabel => arrival != null ? arrival!.name : "Going to";
